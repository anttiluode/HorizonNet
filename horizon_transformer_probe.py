...
plt.tight_layout(); plt.savefig("/home/claude/horizon_transformer_probe.png", dpi=140)
json.dump(res, open("/home/claude/horizon_transformer_probe.json", "w"), indent=2)
